...
const FAQS = [
  ...
  },
  {
    ...
    // TODO: телефон и почта временные, заменить на реальные данные ПАРА | МОДУЛЬ
    a: "24 месяца на каркас и конструкцию, 12 месяцев на отделку и инженерные системы. Заявка принимается по телефону +7 (812) 250-10-25 или на info@para-modul.ru, специалист выезжает в течение 5–7 рабочих дней.",
  },
  {
    g: "Гарантия и оплата",
